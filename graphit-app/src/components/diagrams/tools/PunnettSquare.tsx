...
const DEFAULT_STATE: State = { parent1: 'Aa', parent2: 'Aa' };
...
export default function PunnettSquare(props: PunnettSquareProps) {
  const initialState: State = {
      parent1: props.initialParent1 || DEFAULT_STATE.parent1,
      parent2: props.initialParent2 || DEFAULT_STATE.parent2,
  };
  ...
  const handleReset = () => {
    dispatch({ type: 'SET_PARENT1', payload: DEFAULT_STATE.parent1 });
    dispatch({ type: 'SET_PARENT2', payload: DEFAULT_STATE.parent2 });
  };
  return (
    <DiagramErrorBoundary diagramName="Punnett Square Calculator">
        ...
        <div className="md:col-span-1">
          <Card>
            ...
            <div className="p-6 space-y-6">
              ...
              <DiagramToolbar
                diagramName="Punnett Square Calculator"
                getDiagramState={getDiagramState}
                onExport={() => openExportModal(diagramContainerRef, 'punnett-square')}
                onReset={handleReset}
              />
            </div>
          </Card>
