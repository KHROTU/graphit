...
type Action = 
    ...
    | { type: 'CALCULATE' }
    | { type: 'RESET' };
const DEFAULT_STATE: State = { image: { value: '', unit: 'mm' }, actual: { value: '', unit: 'μm' }, magnification: '', result: '' };
...
export default function MicroscopyCalculator(props: MicroscopyProps) {
  ...
  return (
    <DiagramErrorBoundary diagramName="Microscopy Calculator">
        ...
        <div className="md:col-span-1">
          <Card>
            ...
            <div className="p-6 space-y-4">
              ...
              <DiagramToolbar
                diagramName="Microscopy Calculations"
                getDiagramState={getDiagramState}
                onExport={() => openExportModal(diagramContainerRef, 'microscopy-calculator')}
                onReset={handleReset}
              />
            </div>
          </Card>
