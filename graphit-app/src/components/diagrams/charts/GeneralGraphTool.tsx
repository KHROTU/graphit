...
const BarChartTool = dynamic(() => import('./BarChartTool'), { ssr: false });
const PieChartTool = dynamic(() => import('./PieChartTool'), { ssr: false });
const ScatterPlotTool = dynamic(() => import('./ScatterPlotTool'), { ssr: false });
